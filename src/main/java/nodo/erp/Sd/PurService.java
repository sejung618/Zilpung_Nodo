...
public class PurService {
    ...
    public void create(String PC_Num, String PC_Date, Account account,
                               String PC_Item, String PC_Icode, Integer PC_Count,
    	...
    	pur.setPC_Company(account.getAC_Company());
    	pur.setAccount(account);
